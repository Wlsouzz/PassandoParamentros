...
export default function card({ porcentagem, titulo, imagem, texto, texto2 }) {
  const navigation = useNavigation();
    ...
    return(
        <TouchableOpacity style={estilo.cardTarefa} onPress = {()=>navigation.navigate('Details', {porcentagem:porcentagem, titulo:titulo, imagem:imagem, texto:texto, texto2:texto2})} >
